...
class ConfigLoader:
    ...
    def _default_config(self) -> Dict:
        ...
        return {
            ...
            'agents': {
                'paper_search': {
                    'model': os.getenv('PAPER_SEARCH_MODEL', os.getenv('CLAUDE_MODEL', 'claude-sonnet-4-6')),
                    'max_results': 50
                },
                'hypothesis': {
                    # 首席科学家 PI 使用 Model A
                    'model': os.getenv('PI_MODEL', os.getenv('CLAUDE_MODEL', 'claude-sonnet-4-6'))
                },
                'red_team': {
                ...
                'validation': {
                    'model': os.getenv('VALIDATION_MODEL', os.getenv('CLAUDE_MODEL', 'claude-sonnet-4-6'))
                },
                'tech_analysis': {
                    'model': os.getenv('TECH_ANALYSIS_MODEL', os.getenv('CLAUDE_MODEL', 'claude-sonnet-4-6'))
                }
            },
            'pubmed': {
                'retmax': 50,
    ...
    def get_agent_model(self, agent_name: str) -> str:
        ...
        return agent_config.get('model', os.getenv('CLAUDE_MODEL', 'claude-sonnet-4-6'))
