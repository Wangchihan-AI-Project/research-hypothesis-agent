...
class FitnessResult:
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            'hybrid_fitness': convert_value(self.hybrid_fitness),
            'vector_novelty_score': convert_value(self.vector_novelty_score),
            'red_team_rigor_score': convert_value(self.red_team_rigor_score),
            'physical_validation': convert_value(self.physical_validation),
            'fused': self.fused,
            'fuse_reason': self.fuse_reason,
            'similarity': convert_value(self.similarity),
