...
DOMAIN_SOURCE_MAPPING = {
    ...
    'astronomy': ['arxiv', 'semantic_scholar'],  # V7.1 新增
    ...
    'engineering': ['arxiv', 'semantic_scholar'],  # V7.1 新增：通用工程学
    ...
    'geoscience': ['arxiv', 'semantic_scholar'],  # V7.1 新增：地球科学
...
DOMAIN_KEYWORDS = {
    ...
    'astronomy': [
        'star', 'planet', 'galaxy', 'universe', 'cosmos', 'celestial',
        'orbit', 'solar', 'lunar', 'stellar', 'black hole', 'neutron',
        'supernova', 'asteroid', 'comet', 'telescope', 'observation',
    ],
    'chemistry': [
        'molecule', 'chemical', 'reaction', 'compound', 'element',
        'bond', 'synthesis', 'catalyst', 'organic', 'inorganic',
    ...
    # 工程与材料关键词
    'engineering': [
        'design', 'manufacturing', 'process', 'system', 'control',
        'automation', 'mechanical', 'electrical', 'structural',
        'thermal', 'fluid', 'robot', 'sensor', 'actuator',
    ],
    'materials_science': [
        'material', 'metal', 'ceramic', 'composite', 'nanomaterial',
        'crystal', 'semiconductor', 'superconductor', 'alloy',
        'thin film', 'surface', 'microstructure', 'properties',
    ],

    # 地球与环境关键词
    'geoscience': [
        'earth', 'geology', 'rock', 'mineral', 'plate', 'tectonic',
        'seismic', 'volcano', 'earthquake', 'magma', 'sediment',
        'fossil', 'stratigraphy', 'hydrology', 'oceanography',
    ],
    'environmental_science': [
        'environment', 'ecosystem', 'pollution', 'climate', 'carbon',
        'biodiversity', 'sustainability', 'conservation', 'habitat',
        'emission', 'waste', 'recycling', 'renewable', 'impact',
    ],
